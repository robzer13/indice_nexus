...
export default async function CompanyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <div className="space-y-8">
    ...
    <section className="space-y-4"><h2 className="text-xl font-semibold text-white">Thèse structurée V2</h2><div className="grid gap-4 lg:grid-cols-3"><TextBlock title="Quality case" value={company.quality_case}/><TextBlock title="Valuation case" value={company.valuation_case}/><TextBlock title="Key risk" value={company.key_risk}/></div></section>
