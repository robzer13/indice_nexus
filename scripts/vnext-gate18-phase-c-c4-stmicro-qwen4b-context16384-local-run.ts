...
const AUTHORIZATION_PATH =
  "calibration/vnext/OROTITAN_GATE18_PHASE_C_C4_STMICRO_QWEN3_4B_CONTEXT16384_INFERENCE_AUTH_001.json";
...
async function main(): Promise<void> {
  ...
  const privateArtifact = {
    format:
      "OROTITAN_GATE18_PHASE_C_C4_LOCAL_PRIVATE_RUN_V0.1",
  ...
  console.log(
    JSON.stringify(
      {
        format:
          "OROTITAN_GATE18_PHASE_C_C4_LOCAL_EXECUTION_SUMMARY_V0.1",
        status,
        matrixCellId: MATRIX_CELL_ID,
        company: "STMicroelectronics",
        moduleId: GATE18_PHASE_B_V10_MODULE_ID,
