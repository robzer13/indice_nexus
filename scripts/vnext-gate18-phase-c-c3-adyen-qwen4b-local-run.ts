...
const AUTHORIZATION_PATH =
  "calibration/vnext/OROTITAN_GATE18_PHASE_C_C3_ADYEN_QWEN3_4B_INFERENCE_AUTH_001.json";
...
function readAndAssertAuthorization(
  ...
  if (
    ...
    artifact.c3_inference.execution_id !==
      "ADYEN_CLAIM_TARGET_CORE_001_LOCAL_COMPACT_QWEN4B_4096" ||
...
async function main(): Promise<void> {
  ...
  const outputPath = resolve(
    privateDir,
    `${isoFileSafe(completedAt)}__ADYEN_CLAIM_TARGET_CORE_001_LOCAL_COMPACT_QWEN4B_4096.json`,
  );
