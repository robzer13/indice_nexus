...
async function main(): Promise<void> {
  ...
  const payload = {
    format: "OROTITAN_GATE18_PHASE_C_C4_QWEN3_4B_CONTEXT16384_LOAD_SMOKE_V0.1",
    gate: 18,
    phase: "C_LOCAL_FIRST_MODEL_QUALIFICATION",
    stage: "C4_CONTEXT_GROWTH_LOAD_SMOKE",
    ...
    interpretationBoundary: {
      ...
      nextAction:
        "Human review of 16384-context load-only RAM/VRAM measurements before any C4 inference authorization.",
    },
  };
