...
const AUTHORIZATION_PATH =
  "calibration/vnext/OROTITAN_GATE18_PHASE_C_C4_STMICRO_QWEN3_4B_CONTEXT16384_OUTPUT1024_TIMEOUT420_AUTH_001.json";
...
const ATTEMPT_ID =
  "C4_STMICRO_MOAT_EVIDENCE_AUDIT_QWEN4B_CONTEXT16384_OUTPUT1024_TIMEOUT420_GUARDED_001";
...
function readAndAssertAuthorization(
  ...
  if (
    ...
    artifact.status !== "AUTHORIZED_SINGLE_LOCAL_OUTPUT_BUDGET_REMEDIATION" ||
