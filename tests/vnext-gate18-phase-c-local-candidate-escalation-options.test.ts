...
test("expanded local candidate registry preserves ordering while recording Phi-4 mini load fit", () => {
  ...
  assert.equal(registry.status, "POST_C4_PHI4_MINI_BROOKFIELD_TARGETED_PASS_ADYEN_PENDING");
  ...
  assert.equal(phi.admission_state, "BROOKFIELD_TARGETED_PASS_ADYEN_PENDING_CONTEXT4096");
